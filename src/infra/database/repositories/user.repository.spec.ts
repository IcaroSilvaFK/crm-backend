...
describe("#UserRepository", () => {
  ...
  it("#store", async () => {
    ...
    const user = new UserEntity("test@test.com", "1234", "test", UserRoles.USER)
  ...
  it("#findById", async () => {
    ...
    const user = new UserEntity("test@test.com", "1234", "test", UserRoles.ADMIN)
  ...
  it("#update", async () => {
    const baseUser = new UserEntity("teste@test.com", "123", "test", UserRoles.ADMIN)
  ...
  it("#destroy", async () => {
    ...
    const user = new UserEntity("teste@test.com", "123", "test", UserRoles.ADMIN)
